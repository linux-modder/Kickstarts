...
# Updated for RHEL 7 / CentOS 7 / Fedora  20+ (namely SysD support) with addition of netinstall
...
#url --url http://{mirror-of-choice}/pub/CentOS/7.1.1503/os/x86_64/  ## mirror list available @ http://centos.org/download/mirrors
lang en_US.UTF-8
keyboard us
